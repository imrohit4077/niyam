...
export function DashboardSummaryCard({ title, value, icon, trend, subtitle, variant = 'default' }: Props) {
  const trendClass =
    trend == null
      ? 'dashboard-kpi-trend dashboard-kpi-trend--muted'
      : trend.direction === 'up'
  ...
  const arrow = trend == null ? '—' : trend.direction === 'up' ? '↑' : trend.direction === 'down' ? '↓' : '→'
...
export function DashboardKpiIconCandidates() {
  return (
...
export function DashboardKpiIconBriefcase() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
...
export function DashboardKpiIconCalendar() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
...
export function DashboardKpiIconOffer() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
