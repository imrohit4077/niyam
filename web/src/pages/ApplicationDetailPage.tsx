...
export default function ApplicationDetailPage() {
  ...
  return (
    <div className="app-cand-page">
      ...
      <div className="app-cand-grid">
        <section className="app-cand-card">
          ...
          <div className="app-cand-card-body">
            <div className="app-cand-fields">
              ...
              <Field label="LinkedIn">
                <input className="app-cand-input" value={linkedinUrl} onChange={e => setLinkedinUrl(e.target.value)} placeholder="https://…" />
              </Field>
        ...
        <section className="app-cand-card app-cand-card--wide">
          ...
          <div className="app-cand-card-body">
            <div className="app-cand-esign-toolbar">
              ...
              <p className="app-cand-esign-foot">
                Configure templates and stage rules under <Link to={`/account/${accountId}/settings/esign`}>Settings → E-sign</Link>.
              </p>
            </div>
                  ...
                  return (
                    <div key={sc.id} className="scorecard-summary-card">
                      <div className="scorecard-summary-head">
                        ...
                        {sc.criteria_average != null && <span className="scorecard-summary-avg">Avg {sc.criteria_average}</span>}
