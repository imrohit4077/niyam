"""GET/PATCH /api/v1/account/esign_settings"""
...
from app.services.esign_settings_service import EsignSettingsService


class AccountEsignSettingsController(BaseController, Authenticatable):
    @before_action
